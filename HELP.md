...
* [Spring Data Neo4j](https://docs.spring.io/spring-boot/docs/3.2.0-SNAPSHOT/reference/htmlsingle/index.html#data.nosql.neo4j)
...
```
$ build/native/nativeCompile/heimskringla
```
